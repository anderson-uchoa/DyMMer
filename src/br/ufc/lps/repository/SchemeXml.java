...
public class SchemeXml {
	...
	@Expose
	private List<MeasuresContexts> measuresContexts;
	...
	public List<MeasuresContexts> getMeasuresContexts() {
		return measuresContexts;
	}

	public void setMeasuresContexts(List<MeasuresContexts> measuresContexts) {
		this.measuresContexts = measuresContexts;
	}
	...
	public String toString() {
		return "SchemeXml [numberOfFeatures=" + numberOfFeatures + ", numberOfOptionalFeatures="
				...
				+ nonFunctionalCommonality + ", numberOfContexts=" + numberOfContexts + ", measuresContexts="
				+ measuresContexts + ", file=" + file + "]";
	}	
